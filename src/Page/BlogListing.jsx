    ...
    <Link to={`/blog/${blog.slug}`} className="group block">
      <div className="bg-white rounded-2xl overflow-hidden border border-surface-container-high shadow-[0_4px_24px_rgba(20,37,136,0.06)] hover:shadow-[0_8px_40px_rgba(20,37,136,0.12)] transition-all duration-300 grid lg:grid-cols-2">
        ...
        <div className="p-8 lg:p-10 flex flex-col justify-center">
          ...
          <h2 className="font-headline font-black text-primary text-2xl lg:text-3xl leading-tight mb-4 group-hover:text-primary-container transition-colors">
            {blog.title}
          </h2>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <p className="text-sm font-bold text-on-surface">{blog.author || 'JP Neuro-Spine'}</p>
      ...
      <article className="bg-white rounded-2xl overflow-hidden border border-surface-container-high shadow-[0_2px_16px_rgba(20,37,136,0.04)] hover:shadow-[0_8px_32px_rgba(20,37,136,0.10)] hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
        ...
        <div className="relative overflow-hidden aspect-[16/9] flex-shrink-0 bg-primary/5">
          ...
          <div className="absolute bottom-3 left-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-white bg-primary/80 backdrop-blur-sm px-2.5 py-1 rounded-full">
              Health Article
            </span>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-6 flex flex-col flex-grow">
          <h3 className="font-headline font-bold text-primary text-base sm:text-lg leading-snug mb-3 line-clamp-2 group-hover:text-primary-container transition-colors">
            {blog.title}
          </h3>
          ...
          <div className="border-t border-outline-variant/20 pt-4 mt-auto flex items-center justify-between gap-2">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-on-surface-variant">{formatDate(blog.created_at)}</p>
              </div>
            </div>
  ...
  return (
    <main className="bg-surface text-on-surface font-body min-h-screen pt-16 sm:pt-20">
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-[#0d1a6b] via-primary to-primary-container">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20 sm:py-28">
          <div className="max-w-2xl">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-primary-fixed/50 text-sm mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-headline font-black text-on-primary leading-[1.1] tracking-tight mb-5">
              Health &amp; Wellness<br />
              <span className="text-on-tertiary-container">Knowledge Centre</span>
            </h1>
            <p className="text-primary-fixed/70 text-base sm:text-lg leading-relaxed max-w-xl">
            ...
            {!loading && blogs.length > 0 && (
              <div className="flex items-center gap-6 mt-8">
                <div className="flex items-center gap-2 text-primary-fixed/60 text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pb-24">
        ...
        {/* Error */}
        {error && (
          <div className="flex items-center gap-3 bg-error-container text-on-error-container px-5 py-4 rounded-xl text-sm border border-error/10 my-10">
        ...
        {!loading && !error && blogs.length === 0 && (
          <div className="text-center py-32">
            ...
            <h3 className="text-2xl font-headline font-bold text-primary mb-2">No articles yet</h3>
            <p className="text-on-surface-variant">Our first article is on its way. Check back soon!</p>
          </div>
        )}
        ...
        {!loading && blogs.length > 0 && (
          <>
            ...
            <div className="flex items-center justify-between pt-12 pb-8">
              <div>
                <p className="text-primary font-black uppercase tracking-[0.2em] text-xs sm:text-sm mb-1">From Our Specialists</p>
                <h2 className="text-2xl sm:text-3xl font-headline font-black text-primary">Latest Articles</h2>
              </div>
              <span className="hidden sm:block text-on-surface-variant text-sm font-medium bg-surface-container px-3 py-1.5 rounded-full">
            ...
            <div className="relative bg-gradient-to-br from-primary to-primary-container rounded-3xl overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12 p-8 sm:p-12">
                <div className="lg:flex-1 text-center lg:text-left">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-headline font-black text-on-primary mb-3 leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
                  <Link
                    to="/book-appoinment"
                    className="inline-flex items-center justify-center gap-2 bg-on-primary text-primary px-7 py-3.5 rounded-md font-bold text-sm hover:bg-primary-fixed transition-all shadow-lg"
                  >
                    Book Appointment
